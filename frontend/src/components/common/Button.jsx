...
export const Button = ({
  ...
  const baseStyle = "inline-flex items-center justify-center font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0B0F17] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer";
  
  const variants = {
    primary: "bg-cyan-600 hover:bg-cyan-500 text-white focus:ring-cyan-500 shadow-md shadow-cyan-900/20 border border-cyan-500/30",
