...
class Settings(BaseSettings):
    ...
    # Microgrid Fixed Location: Dhordo, Kutch, Gujarat, India
    LOCATION_NAME: str = "Dhordo, Kutch, Gujarat, India"
    LOCATION_SHORT: str = "Dhordo, Kutch, Gujarat"
    COMMUNITY_NAME: str = "Dhordo Community Microgrid"
    COUNTRY: str = "India"
    STATE: str = "Gujarat"
    DISTRICT: str = "Kutch"
    DEFAULT_LATITUDE: float = 23.84
    DEFAULT_LONGITUDE: float = 69.76
