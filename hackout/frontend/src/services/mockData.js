...
export const initialSystemStatus = {
  ...
  location: {
    name: "Dhordo, Kutch, Gujarat, India",
    shortName: "Dhordo, Kutch, Gujarat",
  ...
  weather: {
    ...
    location: "Dhordo, Kutch, Gujarat, India",
  ...
  priorities: [
    {
      ...
      maxKw: 15.0,
      items: [
        { name: "Dhordo Community Health Centre", kw: 8.5, status: "PROTECTED" },
